...
const  SearchPage = () => {
  ...
  return (
    <div className='w-full flex flex-col mb-96  mt-40  justify-center'>
        ...
        <input text="text" name="key" required value={key} onChange={handleOnChange} onKeyUp={handleSubmit}   className='search-box border-double border-4 border-sky-500 rounded-lg w-3/5 h-12 m-auto' placeholder="Search" />
