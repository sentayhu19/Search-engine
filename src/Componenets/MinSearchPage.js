...
const  MinSearchPage = () => {
    ...
    return (
      <div className='w-full flex mb-7 mt-8'>
        ...
        <Link to="/">  <h4 className='text-yellow-700 m-auto text-4xl text-center logo-font sm:mb-7 md:mb-0 '>አrada Search</h4></Link>
          <input text="text" name="key" required value={key} onChange={handleOnChange} onKeyUp={handleSubmit} className='search-box border-double border-4 border-sky-500 rounded-lg w-80 h-12 m-auto' placeholder="Search" /> 
